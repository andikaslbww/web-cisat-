...
<head>
    ...
    <title>Ekstrakulikuler SMK PK CIBITUNG 1</title>
...
<body>
    ...
    <div class="title">
        ...
        <p class="text-center">Beberapa Ekstrakulikuler Yang Dimiliki SMK PK CIBITUNG 1</p>
    </div>

    <div class="container ekstrakulikuler">
        <a href="perEkstrakulikuler.php" class="perEkstrakulikuler">
            <p>FUTSAL</p>
        </a>
