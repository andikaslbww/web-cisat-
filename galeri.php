...
<body>
    ...
    <div class="container">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                <tr>
                    <td><img width="100" height="50" src="images/HARI GURU.jpg" alt=""></td>
                    <td>HARI GURU</td>
                    <td><a href="perGaleri.php" class="btn btn-primary">Selengkapnya</a></td>
                </tr>


                <tr>
                    <td><img width="100" height="50" src="images/CSMEAT.jpg" alt=""></td>
                    <td>CLAESMEAT</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/SMP.jpg" alt=""></td>
                    <td>MPLS</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/ULTAHCS.jpg" alt=""></td>
                    <td>ULANG TAHUN SEKOLAH</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/PEMILOS.jpg" alt=""></td>
                    <td>PEMILOS</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/BUKBER.jpg" alt=""></td>
                    <td>BUKA BERSAMA</td>
                    <td><a href="" class="btn btn-primary">Selengkapnya</a></td>
                </tr>
            </tbody>
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">official@smkpkcibitung1.com</p>
                        </div>
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">Jl. Keramat, Kec. Wanajaya - Kab. Bekasi</p>
                        </div>
